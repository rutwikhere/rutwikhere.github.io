  ...
  return (
    <section id="contact" className="py-32 px-6 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10 text-center">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold font-grotesk mb-6">Let's build<br/>something <span className="text-gradient">epic.</span></h2>
          <p className="text-xl text-white/60 mb-12 max-w-2xl mx-auto font-light">
            I'm always open to discussing new projects, creative ideas, or opportunities to be part of your visions.
          </p>
          
          <a href="mailto:rutwikwakale004@gmail.com" className="inline-block relative group">
            ...
            <div className="relative px-10 py-5 bg-black rounded-full border border-white/20 text-white font-semibold text-lg flex items-center gap-3">
